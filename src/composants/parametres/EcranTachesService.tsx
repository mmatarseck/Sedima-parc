...
function Interieur({ taches }: { taches: TacheService[] }) {
  ...
  const colonnes = useMemo<ColonneListe<TacheService>[]>(
    () => [
      ...
      { cle: "utilisations", libelle: "Utilisations (parc)", parDefaut: true, largeur: 150, alignee: "droite", tri: (t) => t.utilisations, rendu: (t) => <span className="code">{t.utilisations || "—"}</span> },
