...
export function EcranCouts({ donnees, aujourdhui, vueInitiale = "synthese" }: { donnees: DonneesVehicule[]; aujourdhui: string; vueInitiale?: VueCouts }) {
  ...
  const colonnes = useMemo<ColonneListe<BilanVehicule>[]>(
    () => [
      ...
      { cle: "immobilisation", libelle: "Immobilisé", parDefaut: false, largeur: 100, alignee: "droite", tri: (b) => b.immobilisationJours, rendu: (b) => (b.immobilisationJours !== null && b.immobilisationJours > 0 ? <span className="code">{b.immobilisationJours} j</span> : <Tiret />) },
