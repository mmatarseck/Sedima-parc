...
const PROFILS: Record<string, Omit<ProfilTransporteur, "numero">> = {
  ...
  "Abdou Kane": { forme: "particulier", sousContrat: false, referenceContrat: null, debutContrat: null, finContrat: null, modes: ["tonne"], camionsEngages: 7, regimeFiscal: "a-confirmer", commentaire: "Client SEDIMA — transport compensé sur les achats." },
  "Abdou Dieng": { forme: "particulier", sousContrat: false, referenceContrat: null, debutContrat: null, finContrat: null, modes: ["tonne"], camionsEngages: 10, regimeFiscal: "tva", commentaire: "Client SEDIMA — le plus gros porteur du relevé." },
  "Sokhna Diop": { forme: "particulier", sousContrat: false, referenceContrat: null, debutContrat: null, finContrat: null, modes: ["tonne"], camionsEngages: 2, regimeFiscal: "tva", commentaire: "Cliente SEDIMA — transport compensé." },
  "Moussa Kane": { forme: "particulier", sousContrat: false, referenceContrat: null, debutContrat: null, finContrat: null, modes: ["tonne"], camionsEngages: null, regimeFiscal: "a-confirmer", commentaire: null },
  "Abdou K. Diop": { forme: "particulier", sousContrat: false, referenceContrat: null, debutContrat: null, finContrat: null, modes: ["tonne", "mission"], camionsEngages: 4, regimeFiscal: "a-confirmer", commentaire: "Rattaché à la ligne « AUTRES » du relevé et au bon de commande « divers transport route »." },
  "Dr Wade Transport": { forme: "societe", sousContrat: false, referenceContrat: null, debutContrat: null, finContrat: null, modes: ["tonne"], camionsEngages: 3, regimeFiscal: "a-confirmer", commentaire: null },
  "Dème Transport": { forme: "societe", sousContrat: false, referenceContrat: null, debutContrat: null, finContrat: null, modes: ["mission"], camionsEngages: null, regimeFiscal: "brs", commentaire: "Transfert de poulets vers l'abattoir, au voyage." },
  "Djily Transport": { forme: "societe", sousContrat: false, referenceContrat: null, debutContrat: null, finContrat: null, modes: ["tonne"], camionsEngages: null, regimeFiscal: "a-confirmer", commentaire: null },
  "Mouhamed Sy": { forme: "particulier", sousContrat: false, referenceContrat: null, debutContrat: null, finContrat: null, modes: ["mission"], camionsEngages: null, regimeFiscal: "brs", commentaire: "Œufs et farine, prix au sac — hors grille à la tonne." },
  "Dame Ndoye": { forme: "particulier", sousContrat: false, referenceContrat: null, debutContrat: null, finContrat: null, modes: ["mission"], camionsEngages: null, regimeFiscal: "brs", commentaire: "Transport du personnel des abattoirs." },
  K2SBT: { forme: "societe", sousContrat: false, referenceContrat: null, debutContrat: null, finContrat: null, modes: ["mission"], camionsEngages: null, regimeFiscal: "a-confirmer", commentaire: "Livraison d'œufs." },
  "Aïssata Gaye": { forme: "particulier", sousContrat: false, referenceContrat: null, debutContrat: null, finContrat: null, modes: ["tonne"], camionsEngages: null, regimeFiscal: "brs", commentaire: "Liaisons Gambie et Casamance." },
};
