...
export const ACCES_DEMO: AccesUtilisateur[] = [
  ...
  { id: "u-mdiaw", prenom: "Moustapha", nom: "Diaw", courriel: "detenteur@sedima.test", telephone: "76 637 36 79", fonction: "Chauffeur titulaire de AA 032 EA, dépôt Thiès", matricule: "99940", actif: true, profil: "detenteur", perimetre: PERIMETRE_ENTIER, modules: {}, sanctions: null, ecartsApprouves: true, approuvePar: null, chauffeurId: "moustapha-diaw", attributaireId: null, creeLe: cree, modifieLe: null },
];
