...
import { Activity, BellRing, Car, ChevronRight, FileCheck2, Fuel, Gauge, ListChecks, LockKeyhole, Trophy, Truck, Users, Wallet, Wrench } from "lucide-react";
...
const SECTIONS = [
  ...
  { href: "/parametres/diagnostic", libelle: "Diagnostic", precision: "Chaque lecture de la base chronométrée, avec son erreur s'il y en a une — réservé à l'administrateur et à la direction", icone: Activity, livre: true },
