...
import { BellRing, Car, ChevronRight, FileCheck2, Fuel, ListChecks, LockKeyhole, Trophy, Users, Wrench } from "lucide-react";
 ...
 *
 * Les neuf sections sont livrées. Trois d'entre elles **montrent sans laisser
...
export default function PageParametres() {
  return (
    <div className="defilement-discret flex flex-col gap-5 px-8 py-7 lg:h-full lg:overflow-y-auto">
      <TitreEcran titre="Paramètres" sousTitre="Ce qui règle l'application — neuf sections : six où l'on saisit, trois qui montrent et disent pourquoi" />
