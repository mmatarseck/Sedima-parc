...
export default async function PageTelephone() {
  ...
  return <EcranTelephoneAccueil lignes={await lignesFlotte(parametres)} aujourdhui={DATE_REFERENCE} demandes={demandes} transferts={transferts} maintenant={maintenant} />;
}
