-- ============================================================================
-- SEDIMA Parc — 0036 : « zéro litre » cesse de mentir.
--
-- Le carburant réel a été chargé le 10 septembre 2026 : 5 871 pleins, de
-- février 2022 à **juillet 2026**. Le dossier s'arrête là, et nous sommes en
-- septembre. La fenêtre de vingt-huit jours que lit le tableau de bord tombe
-- donc entièrement après le dernier relevé, et la pastille « Carburant »
-- affichait **0 L, comme la semaine passée** — c'est-à-dire « la flotte n'a
-- rien consommé », quand la vérité est « rien n'a été relevé depuis le
-- 31 juillet ».
--
-- C'est le zéro qui ment, encore : il affirme une mesure là où il n'y en a
-- pas. La règle de la maison veut un tiret.
--
-- Ce qu'il fallait pour le dire : **la date du dernier plein connu du parc**.
-- Elle seule permet de distinguer une flotte à l'arrêt d'une source tarie.
-- Elle ne coûte presque rien — un maximum sur une colonne indexée, lu une
-- fois pour toute la fenêtre — et le domaine s'en sert pour rendre la pastille
-- nulle quand la fenêtre est postérieure, avec un complément qui dit la date.
--
-- Le reste de la fonction ne bouge pas. On repart de 0035, comme la leçon de
-- 0035 le demande : une fonction rejouée n'hérite de rien, on part du dernier
-- état.
-- ============================================================================
