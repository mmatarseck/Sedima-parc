-- ============================================================================
-- SEDIMA Parc — 0038 : « 0 t sur 7 jours » cesse de mentir.
--
-- Le relevé de tonnage réel a été chargé le 11 septembre 2026 : 1 079 voyages,
-- du 15 juin au **3 septembre 2026**. La feuille de la semaine suivante existe,
-- mais elle est vide. La fenêtre de sept jours que lit la pastille « Part
-- confiée aux tiers » tombe donc après le dernier voyage relevé, et la pastille
-- affichait « 0 t sur 7 j » — une flotte qui n'aurait rien livré, quand la
-- vérité est « rien n'a été relevé depuis le 3 septembre ».
--
-- C'est le défaut que 0036 a corrigé pour le carburant, et le même remède :
-- **la date du dernier voyage relevé**, rendue avec les champs des tiers et
-- sous le même droit de lecture. Le domaine s'en sert pour dire « dernier
-- relevé le 03/09 » plutôt qu'un zéro.
--
-- On repart de 0037 : une fonction rejouée n'hérite de rien.
-- ============================================================================
