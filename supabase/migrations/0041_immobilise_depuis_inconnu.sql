-- ============================================================================
-- SEDIMA Parc — 0041 : « immobilisé depuis un jour » cesse de mentir.
--
-- Le tableau de bord affichait **18 véhicules hors service sur 47 engagés, et
-- zéro immobilisé depuis plus de sept jours**. Les deux ne peuvent pas être
-- vrais ensemble : les fiches disent « en panne » depuis des semaines, parfois
-- des mois.
--
-- Pourquoi. La durée d'immobilisation d'un véhicule se date à la dernière trace
-- de changement de statut, ou à la réparation en cours. Faute des deux, la
-- fonction reprenait la date de création ou de modification de la fiche. Or le
-- référentiel réel a été chargé le 10 septembre 2026, avec les statuts du jour et
-- sans historique : chaque véhicule en panne paraissait l'être depuis la veille.
--
-- Ce n'est pas une mesure. Sans trace ni réparation, **on ne sait pas depuis
-- quand** : le champ sort nul. Le domaine en tire les conséquences — la pastille
-- dit « — » et combien de véhicules sont immobilisés depuis une date inconnue ;
-- la disponibilité ne se calcule pas tant qu'il en reste. La première trace de
-- changement de statut saisie dans l'application redonne une date.
--
-- On repart de 0038 : une fonction rejouée n'hérite de rien.
-- ============================================================================
